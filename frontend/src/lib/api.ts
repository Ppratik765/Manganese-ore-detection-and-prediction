...
export const SECTORS_LIST: SectorInfo[] = [
  ...
  {
    id: 'bhandara_chikla_sitasawangi',
  ...
  {
    id: 'rajasthan_banswara_tambesra',
  ...
  {
    id: 'jharkhand_singhbhum_chaibasa',
  ...
  {
    id: 'karnataka_sandur_kumaraswamy',
  ...
  {
    id: 'andhra_visakhapatnam_garividi',
